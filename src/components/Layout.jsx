        ...
        <footer className="bg-yellow-900 shadow fixed bottom-0 w-full">
          <nav className="w-full py-4 px-4">
            <ul className="flex justify-around text-sm">
              <li>
                <a href="/register" className="text-yellow-50 hover:text-yellow-400 flex flex-row items-center gap-1">
                  <FilePlusCorner className="w-5 h-5" />
                  <span className="text-xs">登録</span>
                </a>
              </li>
              <li>
                <a href="/list" className="text-yellow-50 hover:text-yellow-400 flex flex-row items-center gap-1">
